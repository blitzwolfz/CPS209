...
public class SavingsAccountMinimumTester
{
	...
	System.out.println("610.54 WAS EXPECTED") ;
...
/**
   ...
   NOTE: this simple version does not have an accountNumber variable
*/
class BankAccount
{  
    //instance variables
...
{  
    ...
    */
    ...
    double interest = this.minimumBalance * (super.interestRate / 100) ;
	deposit(interest);
    this.withdraw(0);
	//-----------------End here. Please do not remove this comment. Reminder: no changes outside the todo regions.
	//-----------------End here. Please do not remove this comment. Reminder: no changes outside the todo regions.
	...
	if (minimumBalance == 0 || this.getBalance() < minimumBalance) minimumBalance = this.getBalance();
	//-----------------End here. Please do not remove this comment. Reminder: no changes outside the todo regions.
	//-----------------End here. Please do not remove this comment. Reminder: no changes outside the todo regions.
    }
}
