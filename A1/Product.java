...
public class Product
{
	...
	{
		return !(productOptions == null || productOptions.trim().isEmpty());
	}
	...
	public void print()
	{
		System.out.printf("%nId: %-5s Category: %-9s Name: %-20s Price: %7.1f", this.id, this.category, this.name, this.price);
	}
