	...
	public static void main(String[] args)
	{
		...
		while (scanner.hasNextLine())
		{
			...
			else if (action.equalsIgnoreCase("SHIP"))	// ship an order to a customer
			{
					...
					if (scanner.hasNextLine()) orderNumber = scanner.nextLine();

					// Ship order to customer (see ECommerceSystem for the correct method to use
					ProductOrder ord = amazon.shipOrder(orderNumber);

					System.out.printf("Order # %s Customer ID: %s Product ID: %s Product Name: %s Options: %s", 
					ord.getOrderNumber(), ord.getCustomer().getId(), ord.getProduct().getId(), ord.getProduct().getName(), ord.getProduct().getId());
			}
			...
			else if (action.equalsIgnoreCase("ORDER")) // order a product for a certain customer
			{
			  ...
			  // Get product Id from scanner
				if (scanner.hasNextLine()) productId = scanner.nextLine();
			  ...
			  // Get customer Id from scanner
				...
				if(ordNum != null) {
					System.out.printf("Order #%s%n", ordNum);
				}
			...
			else if (action.equalsIgnoreCase("CANCEL")) // Cancel an existing order
			{
				...
				if (!success) System.out.println(amazon.errMsg);
				else System.out.println("Order # " + orderNumber + " Cancelled");
			}
